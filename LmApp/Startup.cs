...
namespace LmApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    TermsOfService = new Uri("https://github.com/noemikovacs/LmApp"),
                    Contact = new OpenApiContact
                    {
                        Name = "Kovacs Noemi",
                        Email = string.Empty,
                        Url = new Uri("https://github.com/noemikovacs/LmApp"),
                    },
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "My License Management API V1");
            });
